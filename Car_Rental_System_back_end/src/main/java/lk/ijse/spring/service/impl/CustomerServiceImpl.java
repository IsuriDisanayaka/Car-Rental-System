...
public class CustomerServiceImpl  implements CustomerService {
    ...
    @Override
    public List<CustomerDTO> searchCustomerbyName(String id) {
        List<Customer> customersByName = customerRepo.findCustomersByName(id);
        return mapper.map(customersByName, new TypeToken<List<CustomerDTO>>(){}.getType());
    }
